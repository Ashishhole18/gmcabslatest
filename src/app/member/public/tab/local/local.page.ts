...
export class LocalPage implements OnInit {
 ...
 @ViewChild('search', { static: false }) search: IonSearchbar;
  ...
  onChangeVehicleType(vehicle_type_id) {
    ...
    this.enqiry.vehicle_id=vehicle_type_id;
    if (vehicle_type_id) {
      console.log("here in vehical");
  ...
  onFormSubmit() {
    ...
    if (!this.localForm.valid) {
      ...
      this.enqiry.dropoff_location=this.dropoff_location;
      this.enqiry.picup_location=this.picup_location;
        ...
        result=>{
          ...
          if(result)
          {
            ...
            this.altContrl.create({
              header:'Success',
              message:'Your Ride Saved Successfully',
              buttons:[{
                text:'Ok',
                handler:()=>
              {
